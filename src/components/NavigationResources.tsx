          ...
          <div className="flex flex-col lg:flex-row justify-center gap-6 mb-12">
            ...
            <div className="flex flex-row lg:flex-col justify-center gap-4 lg:w-1/4">
              {navItems.map((item) => (
                <div 
                  ...
                  className={`relative z-10 ${
                    activeNavSection === item.id 
                      ? 'bg-[#005596] text-white translate-x-4 lg:translate-x-6 translate-y-0' 
                      : 'bg-[#e5f0f9]'
                ...
                >
                  <h3 className={`text-xl font-bold ${activeNavSection === item.id ? 'text-white' : 'text-[#005596]'}`}>{item.title}</h3>
                </div>
              ))}
            </div>
